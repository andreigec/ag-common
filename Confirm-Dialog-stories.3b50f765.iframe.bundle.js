...
`},"./src/ui/styles/media.ts":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.d(__webpack_exports__,{BQ:()=>bigScreen,SO:()=>vSmallScreen,UN:()=>smallScreen,do:()=>bigScreenPx,kX:()=>smallScreenPx});const smallScreenPx=1024,bigScreenPx=2e3,vSmallScreen="(max-width: 500px)",smallScreen=`(max-width: ${smallScreenPx}px)`,bigScreen=`(min-width: ${smallScreenPx}px)`},"./stories/Confirm/Dialog.stories.tsx":(__unused_webpack_module,__webpack_exports__,__webpack_require__)=>{__webpack_require__.r(__webpack_exports__),__webpack_require__.d(__webpack_exports__,{Dialog:()=>Dialog,__namedExportsOrder:()=>__namedExportsOrder,default:()=>__WEBPACK_DEFAULT_EXPORT__});var react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__=__webpack_require__("./node_modules/.pnpm/react@19.1.0/node_modules/react/jsx-runtime.js"),_src_ui_components_Confirm__WEBPACK_IMPORTED_MODULE_2__=(__webpack_require__("./node_modules/.pnpm/react@19.1.0/node_modules/react/index.js"),__webpack_require__("./src/ui/components/Confirm/index.tsx"));const ActionWrapper=args=>(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)("div",{style:{color:"white",backgroundColor:"black",height:"5rem",width:"10rem",cursor:"pointer",fontSize:"2rem"},role:"button",tabIndex:-1,onKeyDown:()=>{},onClick:async()=>{const res=await(0,_src_ui_components_Confirm__WEBPACK_IMPORTED_MODULE_2__.T)(args);window.alert("result="+JSON.stringify(res,null,2))},children:"click to open"}),base={title:"UI/Confirm",component:ActionWrapper},Dialog=(args=>(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_0__.jsx)(ActionWrapper,{...args})).bind({});Dialog.args={bottomText:"bottom",topText:"top"};const __WEBPACK_DEFAULT_EXPORT__=base,__namedExportsOrder=["Dialog"];Dialog.parameters={...Dialog.parameters,docs:{...Dialog.parameters?.docs,source:{originalSource:"args => <ActionWrapper {...args} />",...Dialog.parameters?.docs?.source}}}}}]);
//# sourceMappingURL=Confirm-Dialog-stories.3b50f765.iframe.bundle.js.map